...
export const SET_EVAINTERID = 'SET_EVAINTERID'
export const GET_STAGEINFO = 'GET_STAGEINFO'
export const GET_EDITSTAGEINFO = 'GET_EDITSTAGEINFO'
export const GET_STAGEPIC = 'GET_STAGEPIC'
...
// 区域优化
export const GET_EVLRE_GETINTERDATATREE = 'GET_EVLRE_GETINTERDATATREE' // 路口树结构
export const GET_EVLRE_ADDEVLREGIONOPTPLAN = 'GET_EVLRE_ADDEVLREGIONOPTPLAN' // 保存方案
export const GET_EVLRE_GETEVLREGIONOPTSETSELECT = 'GET_EVLRE_GETEVLREGIONOPTSETSELECT' // 区域优化设置下拉
export const GET_EVLRE_GETINTERLSITREFRESH = 'GET_EVLRE_GETINTERLSITREFRESH' // 刷新路口数据
export const GET_EVLRE_GETAREAAVGDELAYTIME = 'GET_EVLRE_GETAREAAVGDELAYTIME' // 区域平均延误
export const GET_EVLRE_GETAREAAVGSPEED = 'GET_EVLRE_GETAREAAVGSPEED' // 区域平均车速
export const GET_EVLRE_GETRDCHLLIST = 'GET_EVLRE_GETRDCHLLIST' // 根据区域获取干线

// 绿波监视
export const GET_LINETREEDATAS = 'GET_LINETREEDATAS'
export const GET_LINEINTERTREEDATAS = 'GET_LINEINTERTREEDATAS'
