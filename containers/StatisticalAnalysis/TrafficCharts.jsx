...
const chartsdata = {
  data: [
    { name: '方案二', value: [15, 12, 25, 88, 60, 21, 20, 5, 18, 65, 19] },
    { name: '方案一', value: [1, 2, 5, 8, 6, 21, 2, 65, 8, 6, 9] },
  ],
  time: ['01:00', '02:00', '03:00', '04:00', '05:00', '06:00', '07:00', '08:00', '09:00', '10:00']
}
...
class TrafficCharts extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      chartsItems: this.props.chartsItems || chartsdata,
    }
  }
  componentDidMount = () => {
  ...
  getOptions = () => {
    ...
    const option = {
      ...
      xAxis: {
        /* name: 'X轴的名字', */
        boundaryGap: false,
        data: chartsItems && chartsItems.time,
        axisLine: {
          lineStyle: {
            color: '#67c6e6',
          },
  ...
  render() {
    return (
      <ReactEcharts option={this.getOptions()} style={{ height: this.props.height || '100%' }} />
    )
  }
}
